...
return [
    'custom' => [
        ...
        'largeScreenLogo' => 'https://vewo.com.mx/assets/logo.png', //we used saparete log image for large screen and small
        'smallScreenLogo' => 'https://vewo.com.mx/assets/logo.png', // pass the image path here e.g:'images/logo/materialize-logo-color.png' note:(Vertical-menu-nav-dark and horizontal-menu template used a single logo in both small and large screen)
